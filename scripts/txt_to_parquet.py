...
def main():
    parser = argparse.ArgumentParser(
        description="Create a Parquet file and JSONL file for training from a text file containing prompts."
    )
    parser.add_argument(
        "--input",
        type=str,
        required=True,
        help="Input text file containing prompts (one per line)",
    )
    parser.add_argument(
        "--prompt_key", type=str, default="prompt", help="Column name for the prompt"
    )
